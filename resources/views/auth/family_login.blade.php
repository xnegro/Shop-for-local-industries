                ...
                <div class="col-md-6 col-12 fxt-bg-img"
                    ...
                    <div class="fxt-intro">
                        ...
                        <div class="fxt-page-switcher">
                            <a href="{{ route('family.login') }}" class="switcher-text1 active">Log In</a>
                            <a href="{{ route('family.register') }}" class="switcher-text1">Register</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-12 fxt-bg-color">
                    <div class="fxt-content">
                        <div class="fxt-form">
                            ...
                            <form method="POST" action="{{ route('family.log.val') }}">
                                @csrf
