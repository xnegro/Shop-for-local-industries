                        ...
                        <div class="col-lg-8">
                            <div class="card mb-3 mb-lg-5">
                                ...
                                <div class="card-header">
                                    <form action="/admin/product/{{ $id->id }}/update" method="post">
                                        @csrf
                                        <!-- Card -->
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card mb-3 mb-lg-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="price" id="priceNameLabel"
                                                placeholder="0.00" aria-label="0.00" value="{{ $id->price }}">
                                            ...
                                            <select class="js-select form-select" name="category" autocomplete="off"
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->title }}"
                                                        @if ($category->title == $id->category) selected @endif>
                                    ...
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="categoryLabel" class="form-label">Family</label>

                                        <!-- Select -->
                                        <div class="tom-select-custom">
                                            <select class="js-select form-select" name="family_id" autocomplete="off"
                                                id="categoryLabel"
                                                data-hs-tom-select-options='{
                                                  "searchInDropdown": false,
                                                  "hideSearch": true,
                                                ...
                                                <option label="empty">Select The Owner</option>
                                                @foreach ($families as $family)
                                                    <option @if ($id->family_id == $family->id) selected @endif
