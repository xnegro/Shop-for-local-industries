                                    ...
                                    <tr>
                                        ...
                                        <td class="table-column-ps-0">
                                            <a class="d-flex align-items-center">
                                                <div class="avatar avatar-circle">
                                                    <img class="avatar-img" src="{{ asset('images/' . $product->img) }}"
                                        ...
                                        <td>
                                            @foreach ($categories as $category)
                                                @if ($category->title == $product->category)
                                                    <span
                                                        class="legend-indicator bg-warning"></span>{{ $product->category }}
                                                @endif
                                            @endforeach
                                        </td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-white btn-sm"
                                                onclick="location.href='/admin/product/{{ $product->id }}/edit'">
                                            ...
                                            @if ($product->status != 'Publish')
                                                <button type="button" class="btn btn-success btn-sm"
                                                    onclick="location.href='/admin/product/{{ $product->id }}/active'">
                                                    <i class="bi-check2-all me-1"></i> Active
                                                </button>
                                            @else
                                                <button type="button" class="btn btn-info btn-sm"
                                                    onclick="location.href='/admin/product/{{ $product->id }}/deactive'">
                                                    <i class="bi-slash-circle me-1"></i> Deactivate
                                                </button>
                                            @endif
                                        </td>
                                    </tr>
