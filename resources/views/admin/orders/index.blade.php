                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu mt-1" aria-labelledby="moreOptionsDropdown">
                                            ...
                                            @if ($id->status != 'canceled')
                                                <a class="dropdown-item" href="/admin/request/{{ $id->id }}/cancel">
                                                    <i class="bi-x dropdown-item-icon"></i> Cancel order
                                                </a>
                                            @elseif ($id->status != 'successful')
                                                <a class="dropdown-item"
                                                    href="/admin/request/{{ $id->id }}/completed">
                                                    <i class="bi-check dropdown-item-icon"></i> Completed order
                                                </a>
                                            @endif
                                            <a class="dropdown-item" href="/admin/request/{{ $id->id }}/delete">
